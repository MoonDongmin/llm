    ...
    const trainingPrompt = [
        {
            ...
            content: [
                ...
                metadataPrompt,
                "이 정보를 바탕으로 테이블에 없는 속성 정보를 사용하지말고 이후 사용자의 SQL 요청에 응답하세요. 테이블 스키마에 기반하여 정확하고 실행 효율이 높으며, 대규모 데이터셋에서도 성능 저하 없이 동작하는 최적화된 SQL 쿼리를 작성하세요. 주석 없이, NULL 예외 처리를 포함하고, 가독성 있는 스타일로 작성하세요.",
            ].join("\n\n"),
        },
        {
            role: "system",
